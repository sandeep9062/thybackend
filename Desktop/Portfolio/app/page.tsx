  ...
  return (
    <main className="bg-white text-gray-800">
      ...
      <section id="home" className="flex flex-col items-center justify-center h-screen text-center px-4 bg-gradient-to-r from-blue-50 to-blue-100">
        <Image
          src="/sandeepsaini.jpg"
          alt="sandeep saini"
          width={200}
          height={200}
          className="rounded-2xl mb-4 shadow-md border-4 border-blue-100 transition-transform duration-300 hover:scale-105 hover:shadow-lg hover:border-blue-300"
        />

        <h1 className="text-5xl md:text-6xl font-bold mb-4">
          Hi, I am <span className="text-blue-600">Sandeep Saini</span>
        </h1>
        <p className="text-xl mb-6">Full Stack Developer | MERN | NEXTjs | REACTjs</p>
      ...
      <section id="about" className="max-w-6xl mx-auto px-6 py-20">
        ...
        <p className="text-lg text-center max-w-3xl mx-auto mt-6">
          I hold an <span className="text-blue-600 font-medium">MCA in Computer Science</span> and have completed certifications including <span className="text-blue-600 font-medium">Google’s Digital Marketing</span>, <span className="text-blue-600 font-medium">Sigma Web Development</span>, and <span className="text-blue-600 font-medium">Backend Development</span> by JavaScript Mastery. Skilled in <span className="text-blue-600 font-medium">Next.js</span>, <span className="text-blue-600 font-medium">Tailwind CSS</span>, <span className="text-blue-600 font-medium">Arcjet</span>, and <span className="text-blue-600 font-medium">Upstash</span>.
        </p>
        <p className="text-lg text-center max-w-3xl mx-auto mt-6">
          My approach focuses on <span className="text-blue-600 font-medium">clean code</span>, <span className="text-blue-600 font-medium">scalability</span>, and optimizing <span className="text-blue-600 font-medium">user experiences</span>. I enjoy working on <span className="text-blue-600 font-medium">innovative projects</span> that solve real-world problems.
        </p>
      </section>
